              ...
              <div className="" id='event'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2rem] lg:gap-[10rem] aboutt">
                            ...
                            <div>
                              ...
                              <Modal.Body>
                                <Text id="modal-description" >
                                  <h1 className='font-bold'>Date: 28ᵗʰ March 2025</h1> <br />
                  ...
                  <div className="bg-white shadow-md rounded-lg overflow-hidden w-[19rem] ">
                    ...
                    <div className="p-4 card_content">
                      <h1 className="capitalize text-2xl font-bold text-gray-700"> Mech-a-mind Challenge</h1>
                      <p className="mt-2 text-gray-600 my-7"></p>
                            ...
                            <div>
                              ...
                              <Modal.Body>
                                <Text id="modal-description" >
                                  ...
                                  <p className='font-semibold'>🔹 Quiz Competition Rounds 🔹  

                                   1️⃣ Written Quiz – Test your knowledge on paper.  
                                   2️⃣ Quick Thinking & Audio Listening – Analyze and respond swiftly, 
                                   3️⃣ Model Making – Showcase creativity with a conceptual model.

                                  Get ready to compete and win exciting prizes! 🚀🏆</p>
